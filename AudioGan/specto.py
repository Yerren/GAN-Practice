"""Code from: https://timsainburg.com/python-mel-compression-inversion.html"""
...
plt.show()
wavfile.write("audio_out01.wav", rate, recovered_audio_orig)
...
plt.show()
wavfile.write("audio_out01_mel.wav", rate, inverted_mel_audio)
